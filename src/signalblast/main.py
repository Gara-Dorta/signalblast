...
async def initialise_bot(  # noqa: PLR0913 Too many arguments in function definition
    ...
    bot.signalbot.register(Subscribe(bot=bot))
    bot.signalbot.register(Unsubscribe(bot=bot))
    bot.signalbot.register(Broadcast(bot=bot))
    bot.signalbot.register(DisplayHelp(bot=bot))
    bot.signalbot.register(AddAdmin(bot=bot))
    bot.signalbot.register(RemoveAdmin(bot=bot))
    bot.signalbot.register(BanSubscriber(bot=bot))
    bot.signalbot.register(LiftBanSubscriber(bot=bot))
    bot.signalbot.register(SetPing(bot=bot), contacts=False, groups=True)
    bot.signalbot.register(UnsetPing(bot=bot), contacts=False, groups=True)
    bot.signalbot.register(MessageToAdmin(bot=bot))
    bot.signalbot.register(MessageFromAdmin(bot=bot))
    bot.signalbot.register(LastMsgUserUuid(bot=bot))
