...
async def initialise_bot(  # noqa: PLR0913 Too many arguments in function definition
    ...
    bot.signal_bot.register(Subscribe(bot=bot))
    bot.signal_bot.register(Unsubscribe(bot=bot))
    bot.signal_bot.register(Broadcast(bot=bot))
    bot.signal_bot.register(DisplayHelp(bot=bot))
    bot.signal_bot.register(AddAdmin(bot=bot))
    bot.signal_bot.register(RemoveAdmin(bot=bot))
    bot.signal_bot.register(BanSubscriber(bot=bot))
    bot.signal_bot.register(LiftBanSubscriber(bot=bot))
